// ** React Imports
import { ElementType, Fragment, MouseEvent, useRef } from 'react';
...
const HorizontalNavLink = (props: Props) => {
	...
	const hanldleOnClickItem = (e: MouseEvent<HTMLLIElement>) => {
							...
							? {
									...
									'&.active, &.active:hover': {
										...
										backgroundImage: theme =>
											`linear-gradient(98deg, ${theme.palette.customColors.primaryGradient}, #16642F 94%)`,
