...
const Navigation = (): VerticalNavItemsType => {
	return [
		...
		{
			title: 'PercentageSettings',
			icon: 'mdi:calendar-blank-outline',
			path: '/apps/earnings'
		},
		{ title: 'OpeningOffices', icon: 'mdi:office-building', path: '/apps/office-opening' },
		{ title: 'Articles', icon: 'mdi:newspaper-variant', path: '/apps/articles' },
		{ title: 'Raffles', icon: 'mdi:gift', path: '/apps/raffles' }
