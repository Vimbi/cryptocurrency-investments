							...
							>
								<Box sx={{ mr: 2, display: 'flex', flexDirection: 'column' }}>
									<Box sx={{ mb: 0.5, display: 'flex', alignItems: 'center' }}>
										<Typography sx={{ mr: 0.5, fontWeight: 600, fontSize: '0.875rem' }}>
											{item.title}
										</Typography>
										<Box sx={{ display: 'flex', alignItems: 'center' }}>
											...
											>
												<Icon
													icon={
														item.trendDir === 'down' ? 'mdi:chevron-down' : 'mdi:chevron-up'
													}
												/>
											</Box>
											<Typography
								...
								<Box sx={{ display: 'flex', textAlign: 'end', flexDirection: 'column' }}>
									<Typography sx={{ mb: 0.5, fontWeight: 600, fontSize: '0.875rem' }}>
										{item.sales}
									</Typography>
